class Car(com:String, year:Long, price:Int, owner:String,
          miles:Int,cprice:Int){
    var mf:String = com
    var yr =year
    var p:Int = price
    var ow = owner
...
fun main() {
    ...
    println("--------------")
    var c1=Car("i10",2020,500000,"anuj",1500,650000)
    c1.getCarInformation()
    println("--------------")
    println("Creating class car object c2 in next line.")
    println("Object is created and Init is called")
    println("--------------")
    var c2=Car("i20",2021,800000,"Aman",2000,752000)
